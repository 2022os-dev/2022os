...
pub fn sigqueue_init(pid: Pid) {
    ...
    if let Some(_) = SIGQUEUE
        .write()
        .insert(pid, (Signal::empty(), Signal::empty()))
    {
...
pub fn sigactionbinds_default(signal: Signal) -> SigAction {
    match signal {
        Signal::SIGHUP => SigAction::Term,
        Signal::SIGINT => SigAction::Term,
        Signal::SIGQUIT => SigAction::Core,
        Signal::SIGILL => SigAction::Core,
        Signal::SIGABRT => SigAction::Core,
        Signal::SIGFPE => SigAction::Core,
        Signal::SIGKILL => SigAction::Term,
        Signal::SIGSEGV => SigAction::Core,
        Signal::SIGPIPE => SigAction::Term,
        Signal::SIGALRM => SigAction::Term,
        Signal::SIGTERM => SigAction::Term,
        Signal::SIGUSR1 => SigAction::Term,
        Signal::SIGUSR2 => SigAction::Term,
        Signal::SIGCHLD => SigAction::Ign,
        Signal::SIGCONT => SigAction::Cont,
        Signal::SIGSTOP => SigAction::Stop,
        Signal::SIGTSTP => SigAction::Stop,
        Signal::SIGTTIN => SigAction::Stop,
        Signal::SIGTTOU => SigAction::Stop,
        Signal::SIGBUS => SigAction::Core,
        Signal::SIGPROF => SigAction::Term,
        Signal::SIGTRAP => SigAction::Core,
        Signal::SIGURG => SigAction::Ign,
        Signal::SIGVTALRM => SigAction::Term,
        Signal::SIGXCPU => SigAction::Core,
        Signal::SIGXFSZ => SigAction::Core,
        Signal::SIGSTKFLT => SigAction::Term,
        Signal::SIGIO => SigAction::Term,
        Signal::SIGWINCH => SigAction::Ign,
        _ => {
            panic!("Error")
        }
    }
